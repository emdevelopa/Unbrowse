...
require('./createPackage.js')('linux', { arch: toArch(platform) }).then(function (path) {
  var installerOptions = {
    artifactName: 'Unbrowse-${version}-${arch}.deb',
    packageName: 'Unbrowse',
    icon: 'icons/icon256.png',
    category: 'Network;WebBrowser',
    packageCategory: 'Network',
    mimeTypes: ['x-scheme-handler/http', 'x-scheme-handler/https', 'text/html'],
    maintainer: 'Unbrowsers Developers <280953907a@zoho.com>',
    description: 'Unbrowser is a fast, minimal browser that protects your privacy.',
